...
As originally generated, it will produce a new library project when run:
    ...
    $ clojure -Sdeps '{:deps {net.clojars.dfornika/clj-service {:local/root "."}}}' -Tnew create :template dfornika/clj-service :name myusername/mycoollib
